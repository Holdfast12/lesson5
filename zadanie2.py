...
def summa(*args):
    '''
    Функция, принимающая сколько угодно числовых и текстовых параметров (в том числе и 0) и возвращающая их суммы.
    '''
    t_chisel = 0
    t_strok = ''
    for i in args:
...
print(f'=======================================\nДля введенных параметров\n\tсумма чисел будет равна: {summa_chisel}\n\tсумма строк будет такой: {summa_strok}')
